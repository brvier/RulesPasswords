...
function preGeneratePassword(passwdUrl, passwdMaster, selectedBase,
  hashAlgorithm, whereToUseL33t,
  l33tLevel, passwdLength) {

  var charactersOptions = [];
  charactersOptions.Base16 = '0123456789abcdef';
  charactersOptions.Base58 = '123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz';
  charactersOptions.Numeric = '0123456789';
  charactersOptions.Base93 = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789`~!@#$%^&*()_-+={}|[]\\:\";\'<>?,./';
  charactersOptions.Alpha = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz';
  charactersOptions.Alphanum = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789';
  charactersOptions.Symbols = '`~!@#$%^&*()_-+={}|[]\\:";\'<>?,./';

  selectedChar = charactersOptions[selectedBase];


  if (hashAlgorithm == "md5_v6" || hashAlgorithm == "hmac-md5_v6") {
    selectedChar = charactersOptions.Base16;
  }
  if (passwdMaster === null) {
    passwdMaster = '';
  }
  ...
  while (password.length < passwdLength) {
    ...
    password += (count === 0) ?
      generatepassword(hashAlgorithm, passwdMaster,
        passwdUrl, whereToUseL33t, l33tLevel,
        passwdLength, selectedChar, '', '') :
      generatepassword(hashAlgorithm, passwdMaster + '\n' + count,
        passwdUrl, whereToUseL33t, l33tLevel,
        passwdLength, selectedChar, '', '');
    count++;
...
if (typeof(PasswordMaker_HashUtils) != "object") {
  var PasswordMaker_HashUtils = {
    ...
    rstr2any: function(input, encoding) {
      ...
      var inp = String(input); // EHJ: added
